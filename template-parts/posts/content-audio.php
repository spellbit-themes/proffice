...
<article class="single-blog innerpage Fullpage post-audio">
  <div class="blog-content">
      <?php if(is_single()){?>
      <h2><?php esc_html(the_title()); ?></h2>
    <?php }else{ ?>
      <h2><a href="<?php the_permalink(); ?>"><?php esc_html(the_title()); ?></a> <span class="badge badge-primary"><i class="fa fa-volume-off" aria-hidden="true"></i></span></h2>
    <?php } ?>
      <?php if(!is_single()){?>
