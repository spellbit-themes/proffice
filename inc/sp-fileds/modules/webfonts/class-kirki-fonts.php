...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'proffice' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'proffice' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'proffice' ),
			'200'       => esc_attr__( 'Light 200', 'proffice' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'proffice' ),
			'300'       => esc_attr__( 'Book 300', 'proffice' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'proffice' ),
			'400'       => esc_attr__( 'Normal 400', 'proffice' ),
			'regular'   => esc_attr__( 'Normal 400', 'proffice' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'proffice' ),
			'500'       => esc_attr__( 'Medium 500', 'proffice' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'proffice' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'proffice' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'proffice' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'proffice' ),
			'700'       => esc_attr__( 'Bold 700', 'proffice' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'proffice' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'proffice' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'proffice' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'proffice' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'proffice' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'proffice' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'proffice' ),
		);
	}
